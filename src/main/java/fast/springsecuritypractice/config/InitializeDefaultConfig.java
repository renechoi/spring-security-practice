package fast.springsecuritypractice.config;

import fast.springsecuritypractice.note.NoteService;
import fast.springsecuritypractice.notice.NoticeService;
import fast.springsecuritypractice.user.User;
import fast.springsecuritypractice.user.UserService;
